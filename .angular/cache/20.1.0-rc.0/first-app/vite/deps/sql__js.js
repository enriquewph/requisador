  ...
  "node_modules/sql.js/dist/sql-wasm.js"(exports, module) {
    ...
    var initSqlJs = function(moduleConfig) {
      ...
      initSqlJsPromise = new Promise(function(resolveModule, reject) {
        ...
        var Ba = __spreadValues({}, f), Ca = "./this.program", Da = (a, b) => {
          throw b;
        }, D = "", Ea, Fa;
        if (ca) {
          var fs = require_fs();
          ...
          Ea = (a) => __async(null, null, function* () {
            a = Ga(a) ? new URL(a) : a;
          ...
          var b = yield fetch(a, { credentials: "same-origin" });
        ...
        function Wa(a, b) {
          return __async(this, null, function* () {
            try {
              var c = yield Va(a);
              return yield WebAssembly.instantiate(c, b);
            } catch (d) {
        ...
        function Xa(a) {
          return __async(this, null, function* () {
            ...
            if (!Ja && "function" == typeof WebAssembly.instantiateStreaming && !Ga(b) && !ca) try {
              ...
              return yield WebAssembly.instantiateStreaming(c, a);
            } catch (d) {
